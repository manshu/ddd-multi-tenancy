@extends('layouts.app')
@section('content')
    <div class="min-h-full" x-data="{ open: false }" @keydown.window.escape="open = false" x-cloak>
        ...
        <main class="-mt-32">
            <div class="relative max-w-4xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
                <div class="bg-gray-50 sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-2xl leading-6 font-medium text-gray-900">Verify your email address</h3>
