            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Or
                        <a href="/register" class="font-medium text-indigo-600 hover:text-indigo-500">register your account
                            today!
                        </a>
                    </p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    @endif
                    <div class="mt-6">
                        <form action="#" method="POST" action="{{ route('password.email') }}" class="space-y-6">
                            @csrf
                            <div>
