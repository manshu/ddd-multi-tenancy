...
use Gurulabs\Http\Authentication\Controllers\ProviderLoginController;
...
Route::get('/auth/{provider}', [ProviderLoginController::class, 'redirectToProvider']);
Route::get('/auth/{provider}/callback', [ProviderLoginController::class, 'handleProviderCallback']);
